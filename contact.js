...
var box = document.getElementById('profilebox');
	$(teambtn).click(function(){
		$(box).html('<div class="profiles">' 
			...
			+ '<br>' 
			+ 'Contact me: mason.harr1@aol.com' 
			+ '<a target="_blank" href="https://github.com/Masonwharr">' 
			+ '<img src="https://assets-cdn.github.com/images/modules/logos_page/GitHub-Logo.png" width="100px" height="25px" align="center" class="social5">' 
			+ '</a>'
			+ '<a target="_blank" href="https://www.linkedin.com/in/mason-harr-a42633133?trk=hp-identity-name">' 
			+ '<img src="http://www.free-icons-download.net/images/linkedin-logo-icon-75239.png" width="100px" height="100px" align="center" class="social6">' 
			+ '</a>'
			+ '</p>'
			+ '</div>');
	});
